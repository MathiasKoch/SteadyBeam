Source-Makefile: feeds/4g/libs/zaptel-1.4.x/Makefile
...
Version: 1.4.12.1-4
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread +kmod-zaptel14 +zaptel14-libtonezone +libnewt
Conflicts: 
Menu-Depends: 
Provides: 
Section: utils
...
Version: 1.4.12.1-4
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread +kmod-zaptel14
Conflicts: 
Menu-Depends: 
Provides: 
Section: libs
